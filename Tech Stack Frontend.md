```mermaid
graph TD;
    A[Tech Stack Frontend] --> B[Komponen];
    A --> C[Tren Perkembangan di 2025];
    A --> D[Kelebihan & Kekurangan];
    A --> E[Perusahaan/Web yang Menggunakan];
    B --> F[HTML/HyperText Markup Language: Bahasa pemrograman yang digunakan untuk membuat struktur dan konten halaman web];
    B --> G[CSS/Cascading Style Sheets: Bahasa pemrograman yang digunakan untuk mengatur tampilan dan format halaman web];
    B --> H[JavaScript: Bahasa pemrograman yang digunakan untuk membuat halaman web interaktif];
    F --> I[Sumber: w3schools.com];
    G --> I;
    H --> I;
